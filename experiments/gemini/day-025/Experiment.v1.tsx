...
export default function HandMoldExperiment() {
  ...
  // Net delta % ≈ (leadPct * -0.034) + (antimonyPct * 0.030) + (tinPct * -0.020)
  ...
  // Pressure with jerk: Delta P = rho * a_jerk * h ≈ 10500 kg/m³ * (jerkForce * 9.81) * 0.025 m
    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', gap: '6px', alignItems: 'center' }}>
          ...
          >
            {lang === 'ko' ? '영-라플라스 표면장력' : 'Young-Laplace'}
          </button>
          ...
          >
            {lang === 'ko' ? '호환 부품 표준 규격' : 'Parts Standards'}
          </button>
